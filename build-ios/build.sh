...
python ../configure.py \
            --enable-project=js \
            --with-toolchain-prefix="`xcode-select --print-path`/Toolchains/XcodeDefault.xctoolchain/usr/bin/" \
            --target=armv7s-apple-darwin \
            --with-ios-target=iPhoneOS --with-ios-min-version=$MIN_IOS_VERSION --with-ios-arch=armv7s \
            --disable-shared-js --disable-tests --disable-ion --disable-debug \
            --enable-optimize=-O3 --enable-strip --enable-install-strip --with-thumb=no --without-intl-api
...
mv ./mozglue/build/libmozglue.a ./dist/temp/libmozglue.armv7s.a
mv ./js/src/libjs_static.a ./dist/temp/libjs_static.armv7s.a
...
if [ -e dist/temp/libjs_static.i386.a ] && [ -e dist/temp/libjs_static.x86_64.a ] && [ -e dist/temp/libjs_static.armv7.a ] && [ -e dist/temp/libjs_static.armv7s.a ] && [ -e dist/temp/libjs_static.arm64.a ] ; then
    echo "creating fat version of the library"
    $LIPO -create -output dist/sdk/libjs_static.a dist/temp/libjs_static.i386.a dist/temp/libjs_static.x86_64.a dist/temp/libjs_static.armv7.a dist/temp/libjs_static.armv7s.a dist/temp/libjs_static.arm64.a
    $LIPO -create -output dist/sdk/libmozglue.a dist/temp/libmozglue.i386.a dist/temp/libmozglue.x86_64.a dist/temp/libmozglue.armv7.a dist/temp/libmozglue.armv7s.a dist/temp/libmozglue.arm64.a
